![the coach card: the complaint "i can't see what you build", answered with a year of contributions drawn as a gold curve. almost all of it lives in private repos.](https://raw.githubusercontent.com/whaamkabaam/whaamkabaam/output/coach.svg)
...
software engineering at code university berlin. summer 2026 at the stanford international honors program.

[discord](https://discord.gg/whaam) · [tiktok](https://tiktok.com/@whaamkabaam) · [twitch](https://twitch.tv/whaamkabaam)

<!--
the card up there is one svg on the output branch of this repo. nothing is proxied through a third party that can go down.

the date on the card is the last time the job actually ran. it is not a promise that it refreshes. if this ever stops, you will watch that date go stale instead of reading a claim.
...
two weights of inter, subset and base64'd into the file. about 25 kb, all in. the build fails on any character that is not in the subset.
